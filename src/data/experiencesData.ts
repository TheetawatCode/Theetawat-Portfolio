...
export const experiences = [
    {
        ...
        description: [
            "Designed and developed a fully responsive web application as a Capstone Project, implementing best practices in UI/UX and leveraging tools like TailwindCSS and React.",
